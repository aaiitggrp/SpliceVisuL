...
data_dir= '../../data/v%s' % version
save_dir = './save_lstm_bi_v%s/' % version
file_path = '../../checkpoints/v%s/lstm_bi/' % version
...
model.save_weights('lstm_bi_%s_%s_%d_final.h5' % (month, day, up_down_stream))
os.chdir(work_dir)
